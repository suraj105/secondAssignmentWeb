...
fetch('students.json')
		...
		for (var i = 0; i < data.length; i++){
           myString[i] = data[i].JD;
           array[i] = myString[i].split('-');
            ...
            if(document.getElementById("drop").value == "Win"){
                if(array[i][1] == "04" || array[i][1] == "05" || array[i][1] == "06" || array[i][1] == "07" || array[i][1] == "08" || array[i][1] == "09" ){
                 table.innerHTML += row
                 }
            }
            else if(document.getElementById("drop").value == "Sum"){
                if(array[i][1] == "03" || array[i][1] == "02" || array[i][1] == "01" || array[i][1] == "12" || array[i][1] == "11" || array[i][1] == "10" ){
                    table.innerHTML += row
                }
            }
